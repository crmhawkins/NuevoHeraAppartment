    ...
    <div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Nuevo Huésped</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="card shadow-sm border-0">
    ...
    <div class="card-body">
        <form action="{{ route('huespedes.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select form-select-lg {{ $errors->has('tipo_documento') ? 'is-invalid' : '' }}" 
                        ...
                        <option value="2" {{ old('tipo_documento') == '2' ? 'selected' : '' }}>Pasaporte</option>
                    </select>
                ...
                <div class="col-12 mt-4">
                    <h6 class="fw-semibold text-primary mb-3">
                        ...
                        Documentos de Identidad <span class="text-danger">*</span>
                    </h6>
                </div>
                
                <!-- Fotos de DNI/Pasaporte -->
                <div class="col-md-6">
                    <label for="foto_dni_frente" class="form-label fw-semibold">
                        <i class="fas fa-camera text-primary me-1"></i>
                        <span id="label-foto-frente">Documento</span> <span class="text-danger">*</span>
                    </label>
                    <input type="file" 
                ...
                <div class="col-md-6" id="foto-reverso-container" style="display: none;">
                    <label for="foto_dni_reverso" class="form-label fw-semibold">
                        <i class="fas fa-camera text-primary me-1"></i>
                        DNI - Reverso <span class="text-danger">*</span>
                    </label>
                    <input type="file" 
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="d-flex gap-2 justify-content-end">
                        <a href="{{ request('reserva_id') ? route('reservas.show', request('reserva_id')) : route('reservas.index') }}" class="btn btn-outline-secondary btn-lg">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Cambiar etiquetas según tipo de documento
        const tipoDocumento = document.getElementById('tipo_documento');
        const labelFotoFrente = document.getElementById('label-foto-frente');
        const fotoReversoContainer = document.getElementById('foto-reverso-container');
        const fotoReversoInput = document.getElementById('foto_dni_reverso');
        
        tipoDocumento.addEventListener('change', function() {
            if (this.value === '1') { // DNI
                labelFotoFrente.textContent = 'DNI - Frente';
                fotoReversoContainer.style.display = 'block';
                fotoReversoInput.required = true;
            } else if (this.value === '2') { // Pasaporte
                labelFotoFrente.textContent = 'Pasaporte';
                fotoReversoContainer.style.display = 'none';
                fotoReversoInput.required = false;
                fotoReversoInput.value = '';
            } else {
                labelFotoFrente.textContent = 'Documento';
                fotoReversoContainer.style.display = 'none';
                fotoReversoInput.required = false;
                fotoReversoInput.value = '';
            }
        ...
        if (form) {
            form.addEventListener('submit', function(e) {
                ...
                const fotoFrente = document.getElementById('foto_dni_frente').files[0];
                const fotoReverso = document.getElementById('foto_dni_reverso').files[0];
                ...
                if (!numeroIdentificacion) {
                    ...
                    Swal.fire({
                        title: 'Error de Validación',
                        text: 'Por favor, ingresa el número de identificación.',
                        icon: 'error',
                        confirmButtonText: 'Entendido'
                    });
                ...
                if (!fotoFrente) {
                    ...
                    Swal.fire({
                        title: 'Error de Validación',
                        text: 'Por favor, sube una foto del documento.',
                        icon: 'error',
                        confirmButtonText: 'Entendido'
                    });
                    document.getElementById('foto_dni_frente').focus();
                    return false;
                }
                
                if (tipoDocumento === '1' && !fotoReverso) {
                    e.preventDefault();
                    Swal.fire({
                        title: 'Error de Validación',
                        text: 'Por favor, sube una foto del reverso del DNI.',
                        icon: 'error',
                        confirmButtonText: 'Entendido'
                    });
                    document.getElementById('foto_dni_reverso').focus();
                    return false;
                }
            });
        }
