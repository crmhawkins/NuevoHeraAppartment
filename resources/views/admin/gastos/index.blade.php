...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Administra todos los gastos del sistema</p>
        </div>
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Crea y gestiona los gastos del sistema</p>
                </div>
                <a href="{{ route('admin.gastos.create') }}" class="btn btn-danger btn-lg">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-2">
                    ...
                    <form action="{{ route('admin.gastos.index') }}" method="GET" id="perPageForm">
                    ...
                    <form action="{{ route('admin.gastos.index') }}" method="GET">
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="search" placeholder="Buscar gastos..." value="{{ request()->get('search') }}">
                            </div>
                            <div class="col-md-2">
            ...
            <div class="table-responsive">
                        ...
                        <tr>
                                ...
                                @if ($gasto->estado_id)
                                    @if ($gasto->estado_id == 1)
                                        <span class="badge bg-warning-subtle text-warning fw-semibold">
                                            <i class="fas fa-clock me-1"></i>{{$gasto->estado->nombre}}
                                        </span>
                                    @elseif ($gasto->estado_id == 2)
                                        <span class="badge bg-primary-subtle text-primary fw-semibold">
                                            <i class="fas fa-check me-1"></i>{{$gasto->estado->nombre}}
                                        </span>
                                    @elseif ($gasto->estado_id == 3)
                                        <span class="badge bg-success-subtle text-success fw-semibold">
                                            <i class="fas fa-check-circle me-1"></i>{{$gasto->estado->nombre}}
                                        </span>
                                    @else
                                        <span class="badge bg-danger-subtle text-danger fw-semibold">
                                            <i class="fas fa-times me-1"></i>{{$gasto->estado->nombre}}
                                        </span>
                                    @endif
                                @else
                            ...
                            <td class="align-middle">
                                @if ($gasto->categoria_id != null)
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="fw-semibold">{{$gasto->categoria->nombre}}</span>
                                    </div>
                                @else
                            ...
                            <td class="align-middle">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="fw-semibold">{{$gasto->title}}</span>
                                </div>
                            </td>
                            <td class="align-middle">
                                @if (!empty($gasto->date))
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="fw-semibold">{{ \Carbon\Carbon::parse($gasto->date)->format('d-m-Y') }}</span>
                                    </div>
                                @else
                                    <span class="text-muted fst-italic">
                            ...
                            <td class="align-middle">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="fw-bold fs-5 text-danger">{{$gasto->quantity}} €</span>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-5">
                                <div class="text-muted">
                                    ...
                                    <p class="text-muted mb-0">No hay gastos que coincidan con los criterios de búsqueda</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
                ...
                <tfoot class="table-light">
                    <tr>
                        ...
                        <td class="fw-bold fs-4 text-danger">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function (event) {
                ...
                const gastoId = form.action.split('/').pop();
                
                Swal.fire({
                    title: '¿Eliminar gasto?',
                    text: `¿Estás seguro de que quieres eliminar el gasto #${gastoId}? Esta acción no se puede deshacer.`,
                    icon: 'warning',
