...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Modifica la pregunta frecuente</p>
        </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <form action="{{ route('admin.faq-apartamentos.update', [$apartamento->id, $faq->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
