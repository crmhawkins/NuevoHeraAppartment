...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Crea una nueva página de información legal</p>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <form action="{{ route('admin.paginas-legales.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <small class="form-text text-muted">
                                URL amigable para la página (ej: sobre-nosotros, terminos-condiciones). Se generará automáticamente desde el título si se deja vacío.
                            </small>
                            @error('slug')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-4">
                                ...
                                <input type="date" 
                                       ...
                                       value="{{ old('fecha_actualizacion', now()->format('Y-m-d')) }}">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" 
                                           ...
                                           value="1"
                                           {{ old('mostrar_en_sidebar', true) ? 'checked' : '' }}>
