...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Hawkins Suite - Nueva Contraseña</title>
        ...
        <style>
            /* Estilos específicos de la página de nueva contraseña */
            :root {
            ...
            <div class="reset-card">
                <div class="reset-header">
                    ...
                    <p class="reset-subtitle">
                        Establece tu nueva contraseña para acceder al sistema
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('password.update') }}" id="resetForm">
                    ...
                    <div class="password-requirements">
                        ...
                        <ul class="requirement-list">
                            <li class="requirement-item" id="req-length">Mínimo 8 caracteres</li>
                            <li class="requirement-item" id="req-uppercase">Al menos una mayúscula</li>
                            <li class="requirement-item" id="req-lowercase">Al menos una minúscula</li>
                            <li class="requirement-item" id="req-number">Al menos un número</li>
                            <li class="requirement-item" id="req-match">Las contraseñas coinciden</li>
                        </ul>
                    </div>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function validatePassword(password) {
                    const requirements = {
                        ...
                        match: password === confirmInput.value && password.length > 0
                    };
                    ...
                    document.getElementById('req-match').classList.toggle('valid', requirements.match);
