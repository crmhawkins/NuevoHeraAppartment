...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('clientes', function (Blueprint $table) {
            ...
            $table->string('codigo_municipio_ine')->nullable()->comment('Código INE del municipio de residencia');
            $table->string('nombre_municipio')->nullable()->comment('Nombre del municipio de residencia');
