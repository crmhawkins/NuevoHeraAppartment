    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('factura_foto')) {
            if ($request->file('factura_foto')->isValid()) {
                ...
                // [2026-04-22] Sanear nombre conservando cualquier caracter
                // legitimo (acentos, eñes, etc.) y eliminando solo los invisibles
                // / de control que rompen Flysystem (ver App\Support\SafeFilename).
